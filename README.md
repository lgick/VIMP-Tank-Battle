...
1. Когда игрок уничтожен, ему записывается поражение (deaths +1) и ставится статус dead.
2. Игрок который уничтожил соперника, получает score +1, но только при условии, что он уничтожил игрока команды соперника (не своей).
   Если игрок уничтожил члена своей команды, с него снимается фраг (score -1).
3. Если игрок уничтожил сам себя, ему записывается поражение (deaths +1).
   Если в команде не осталось больше игроков, записывается поражение команде (deaths +1).
4. Если команда игрока уничтожила команду соперников, команда победитель получает score +1.
   Проигравшая команда получает поражение (deaths + 1).
5. Если игрок меняет команду, его личная статистика обнуляется.
6. Если в команде все игроки вышли, обнуляется статистика команды.
7. Изменения в статистике отправляются игрокам каждый тик.
