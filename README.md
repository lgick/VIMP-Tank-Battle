...
Объект является массивом имеющий две вложенности.

**statArray[0]** - данные для tBodies таблиц.

Имеют три вложенности:
...
* **null** - удаляет строку. Пример: `` ['superman', 1, null] ``
* **''** - меняет значение ячееки на пустое. Пример: `` ['don', 1, ['don', '', 1, 8]] ``
