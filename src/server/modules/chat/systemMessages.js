const MESSAGE_CODES = {
  ...
  BOT_CREATED_FOR_TEAM: 'b:3', // {0} created {1} bot(s) for {2}
  BOT_REMOVED_FROM_TEAM: 'b:4', // {0} removed all bots from {1}
  BOT_CREATED: 'b:5', // {0} created {1} bot(s)
  BOT_REMOVED: 'b:6', // {0} removed all bots
};
