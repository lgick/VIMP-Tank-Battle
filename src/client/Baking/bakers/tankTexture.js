...
// создает текстуры для танка (нормальное состояние и уничтоженное)
// params.colorA - основной цвет танка
// params.colorB - цвет башни и доп. элементов
// renderer - PIXI рендерер
export default function tankTexture(params, renderer) {
  const { colorA, colorB } = params;
