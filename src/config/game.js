...
export default {
  ...
  camera: {
    minSpeed: 0, // скорость, при которой зум минимален
    maxSpeed: 240, // скорость, при которой зум максимален
    minZoom: 1.0, // минимальный зум (камера близко)
    maxZoom: 0.7, // максимальный зум (камера далеко)
    speedSmoothing: 0.005, // коэффициент сглаживания скорости (меньше = плавнее)
  },
};
