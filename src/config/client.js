  ...
  modules: {
    canvasManager: {
      dynamicCamera: {
        ...
        // чувствительность зума (0 - 9)
        // 0 - зум отключен
        // 3 - стандартный баланс
        // 9 - максимальная чувствительность
        // (зум срабатывает от малейшего движения)
        zoomOutFactor: 3,

        // максимально возможное отдаление (0.7 от базового масштаба)
        maxZoomOut: 0.7,

        // плавность изменений позиции камеры
        smoothnessPosition: 0.01,

        // плавность изменений зума камеры
        smoothnessZoom: 0.005,

        // плавность входящей скорости
